                    ...
                    <form action="" method="post">
                        ...
                        <div class=" w-full">
                            ...
                            <div class="sm:flex sm:space-x-4 mb-3">
                                ...
                                <div class="flex space-x-2 items-center m-2">
                                    <input type="radio" name="AllerRetour" id="AllerRetour" value="Portugal" class="w-6 h-6 checked:bg-green-500 checked:hover:bg-green-500 checked:active:bg-green-500 checked:focus:bg-green-500 focus:bg-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"> 
